...
import "../src/IdentityBadge.sol";

contract UidentitybadgeTest is Test {
    Uidentitybadge public registry;
    ...
    function testCannotRegisterDuplicateName() public {
        ...
        vm.prank(user2);
        vm.expectRevert(Uidentitybadge.NameAlreadyRegistered.selector);
        registry.registerName("alice");
    }
    ...
    function testCannotTransferUnownedName() public {
        ...
        vm.prank(user2);
        vm.expectRevert(Uidentitybadge.NotNameOwner.selector);
        registry.transferName("alice", user2);
    }
    ...
    function testInvalidNameLength() public {
        vm.prank(user1);
        vm.expectRevert(Uidentitybadge.InvalidName.selector);
